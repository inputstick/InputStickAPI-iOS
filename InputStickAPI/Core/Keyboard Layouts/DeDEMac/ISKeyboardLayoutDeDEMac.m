 ...
 */
//Keyboard layout: de-DE (MAC) - German (Germany), Mac compatible version

#import "ISKeyboardLayoutDeDEMac.h"


@implementation ISKeyboardLayoutDeDEMac

- (NSString *)layoutDescription {
	return @"German (de-DE, Mac compatible)";
}
