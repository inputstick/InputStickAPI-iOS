...
@interface InputStickKeyboardLayoutFrCAMac () {
...
@implementation InputStickKeyboardLayoutFrCAMac
...
- (InputStickKeyboardKeyModel *)keyModelForCharacter:(int)character {
    ...
    switch (character) {
            ...
            case 192: // À
                ...
                break;
            case 193: // Á
                keyboardKeyModel = [[InputStickKeyboardKeyModel alloc]initWithUnicodeCharacter:character key:4 modifiers:2 deadkey:51 deadkeyModifiers:66];
                break;
            case 194: // Â
            ...
            case 204: // Ì
                ...
                break;
            case 205: // Í
                keyboardKeyModel = [[InputStickKeyboardKeyModel alloc]initWithUnicodeCharacter:character key:12 modifiers:2 deadkey:51 deadkeyModifiers:66];
                break;
            case 206: // Î
            ...
            case 224: // à
                ...
                break;
            case 225: // á
                keyboardKeyModel = [[InputStickKeyboardKeyModel alloc]initWithUnicodeCharacter:character key:4 modifiers:0 deadkey:51 deadkeyModifiers:66];
                break;
            case 226: // â
            ...
            case 236: // ì
                ...
                break;
            case 237: // í
                keyboardKeyModel = [[InputStickKeyboardKeyModel alloc]initWithUnicodeCharacter:character key:12 modifiers:0 deadkey:51 deadkeyModifiers:66];
                break;
            case 238: // î
...
- (NSString *)availableCharactersString {
    //\t\n !"#$%&'()*+,-./0123456789:;<=>?@ABCDEFGHIJKLMNOPQRSTUVWXYZ[\]^_`abcdefghijklmnopqrstuvwxyz{|}~ ¡¢£¥§¨©ª«¬®¯°±´µ¶·º»¿ÀÁÂÃÄÆÇÈÉÊËÌÍÎÏÑÒÓÔÕÖØÙÚÛÜßàáâãäæçèéêëìíîïñòóôõö÷øùúûüÿıŒœŸƒˆˇ˘˙˚˛˜˝Ωπ–—’‚“”„†‡•…‰‹›⁄€™∂∆∏∑√∞∫≈≠≤≥◊ﬁﬂ
    return @"\t\n !\"#$%&\'()*+,-./0123456789:;<=>?@ABCDEFGHIJKLMNOPQRSTUVWXYZ[\\]^_`abcdefghijklmnopqrstuvwxyz{|}~ \u00A1\u00A2\u00A3\u00A5\u00A7\u00A8\u00A9\u00AA\u00AB\u00AC\u00AE\u00AF\u00B0\u00B1\u00B4\u00B5\u00B6\u00B7\u00BA\u00BB\u00BF\u00C0\u00C1\u00C2\u00C3\u00C4\u00C6\u00C7\u00C8\u00C9\u00CA\u00CB\u00CC\u00CD\u00CE\u00CF\u00D1\u00D2\u00D3\u00D4\u00D5\u00D6\u00D8\u00D9\u00DA\u00DB\u00DC\u00DF\u00E0\u00E1\u00E2\u00E3\u00E4\u00E6\u00E7\u00E8\u00E9\u00EA\u00EB\u00EC\u00ED\u00EE\u00EF\u00F1\u00F2\u00F3\u00F4\u00F5\u00F6\u00F7\u00F8\u00F9\u00FA\u00FB\u00FC\u00FF\u0131\u0152\u0153\u0178\u0192\u02C6\u02C7\u02D8\u02D9\u02DA\u02DB\u02DC\u02DD\u03A9\u03C0\u2013\u2014\u2019\u201A\u201C\u201D\u201E\u2020\u2021\u2022\u2026\u2030\u2039\u203A\u2044\u20AC\u2122\u2202\u2206\u220F\u2211\u221A\u221E\u222B\u2248\u2260\u2264\u2265\u25CA\uF8FF\uFB01\uFB02";
}
...
- (NSArray<NSNumber *> *)availableCharactersLUT {
    if (_availableCharactersLUT == nil) {
        ...
        [lut addObject:[NSNumber numberWithInteger:160]];
...
- (InputStickKeyLabels *)keyLabels {
    if (_keyLabels == nil) {
        ...
        [_keyLabels setupKey:0x04 withCharCodesArray:@[@0x00, @0x0061, @0x0041, @0x00E6, @0x00C6, @0x0041, @0x0041, @0x00E6, @0x00C6]];
        [_keyLabels setupKey:0x05 withCharCodesArray:@[@0x00, @0x0062, @0x0042, @0x222B, @0x2264, @0x0042, @0x0042, @0x222B, @0x2264]];
        [_keyLabels setupKey:0x06 withCharCodesArray:@[@0x00, @0x0063, @0x0043, @0x00A2, @0x2020, @0x0043, @0x0043, @0x00A2, @0x2020]];
        [_keyLabels setupKey:0x07 withCharCodesArray:@[@0x00, @0x0064, @0x0044, @0x00AA, @0x02C7, @0x0044, @0x0044, @0x00AA, @0x02C7]];
        [_keyLabels setupKey:0x08 withCharCodesArray:@[@0x00, @0x0065, @0x0045, @0x2202, @0x00AF, @0x0045, @0x0045, @0x2202, @0x00AF]];
        [_keyLabels setupKey:0x09 withCharCodesArray:@[@0x00, @0x0066, @0x0046, @0x0192, @0xFB02, @0x0046, @0x0046, @0x0192, @0xFB02]];
        [_keyLabels setupKey:0x0A withCharCodesArray:@[@0x00, @0x0067, @0x0047, @0x00A9, @0xFB01, @0x0047, @0x0047, @0x00A9, @0xFB01]];
        [_keyLabels setupKey:0x0B withCharCodesArray:@[@0x00, @0x0068, @0x0048, @0x02D9, @0x00B7, @0x0048, @0x0048, @0x02D9, @0x00B7]];
        [_keyLabels setupKey:0x0C withCharCodesArray:@[@0x00, @0x0069, @0x0049, @0x03C0, @0x220F, @0x0049, @0x0049, @0x03C0, @0x220F]];
        [_keyLabels setupKey:0x0D withCharCodesArray:@[@0x00, @0x006A, @0x004A, @0x2206, @0x201A, @0x004A, @0x004A, @0x2206, @0x201A]];
        [_keyLabels setupKey:0x0E withCharCodesArray:@[@0x00, @0x006B, @0x004B, @0x02DA, @0x2044, @0x004B, @0x004B, @0x02DA, @0x2044]];
        [_keyLabels setupKey:0x0F withCharCodesArray:@[@0x00, @0x006C, @0x004C, @0x00A0, @0x2026, @0x004C, @0x004C, @0x00A0, @0x2026]];
        [_keyLabels setupKey:0x10 withCharCodesArray:@[@0x00, @0x006D, @0x004D, @0x00B5, @0x00BA, @0x004D, @0x004D, @0x00B5, @0x00BA]];
        [_keyLabels setupKey:0x11 withCharCodesArray:@[@0x00, @0x006E, @0x004E, @0x00A0, @0x2265, @0x004E, @0x004E, @0x00A0, @0x2265]];
        [_keyLabels setupKey:0x12 withCharCodesArray:@[@0x00, @0x006F, @0x004F, @0x00F8, @0x00D8, @0x004F, @0x004F, @0x00F8, @0x00D8]];
        [_keyLabels setupKey:0x13 withCharCodesArray:@[@0x00, @0x0070, @0x0050, @0x201C, @0x201D, @0x0050, @0x0050, @0x201C, @0x201D]];
        [_keyLabels setupKey:0x14 withCharCodesArray:@[@0x00, @0x0071, @0x0051, @0x0153, @0x0152, @0x0051, @0x0051, @0x0153, @0x0152]];
        [_keyLabels setupKey:0x15 withCharCodesArray:@[@0x00, @0x0072, @0x0052, @0x00B6, @0x00AE, @0x0052, @0x0052, @0x00B6, @0x00AE]];
        [_keyLabels setupKey:0x16 withCharCodesArray:@[@0x00, @0x0073, @0x0053, @0x00DF, @0x00A7, @0x0053, @0x0053, @0x00DF, @0x00A7]];
        [_keyLabels setupKey:0x17 withCharCodesArray:@[@0x00, @0x0074, @0x0054, @0x2122, @0x02D8, @0x0054, @0x0054, @0x2122, @0x02D8]];
        [_keyLabels setupKey:0x18 withCharCodesArray:@[@0x00, @0x0075, @0x0055, @0x0020, @0x02DB, @0x0055, @0x0055, @0x0020, @0x02DB]];
        [_keyLabels setupKey:0x19 withCharCodesArray:@[@0x00, @0x0076, @0x0056, @0x221A, @0x25CA, @0x0056, @0x0056, @0x221A, @0x25CA]];
        [_keyLabels setupKey:0x1A withCharCodesArray:@[@0x00, @0x0077, @0x0057, @0x2211, @0x2030, @0x0057, @0x0057, @0x2211, @0x2030]];
        [_keyLabels setupKey:0x1B withCharCodesArray:@[@0x00, @0x0078, @0x0058, @0x00BB, @0x203A, @0x0058, @0x0058, @0x00BB, @0x203A]];
        [_keyLabels setupKey:0x1C withCharCodesArray:@[@0x00, @0x0079, @0x0059, @0x00A5, @0x02DD, @0x0059, @0x0059, @0x00A5, @0x02DD]];
        [_keyLabels setupKey:0x1D withCharCodesArray:@[@0x00, @0x007A, @0x005A, @0x00AB, @0x2039, @0x005A, @0x005A, @0x00AB, @0x2039]];
        [_keyLabels setupKey:0x1E withCharCodesArray:@[@0x00, @0x0031, @0x0021, @0x00A1, @0x2248, @0x0031, @0x0021, @0x00A1, @0x2248]];
        [_keyLabels setupKey:0x1F withCharCodesArray:@[@0x00, @0x0032, @0x0040, @0x0040, @0x0131, @0x0032, @0x0040, @0x0040, @0x0131]];
        [_keyLabels setupKey:0x20 withCharCodesArray:@[@0x00, @0x0033, @0x0023, @0x00A3, @0x02C6, @0x0033, @0x0023, @0x00A3, @0x02C6]];
        [_keyLabels setupKey:0x21 withCharCodesArray:@[@0x00, @0x0034, @0x0024, @0x20AC, @0x02DC, @0x0034, @0x0024, @0x20AC, @0x02DC]];
        [_keyLabels setupKey:0x22 withCharCodesArray:@[@0x00, @0x0035, @0x0025, @0x221E, @0xF8FF, @0x0035, @0x0025, @0x221E, @0xF8FF]];
        [_keyLabels setupKey:0x23 withCharCodesArray:@[@0x00, @0x0036, @0x003F, @0x0020, @0x2020, @0x0036, @0x003F, @0x0020, @0x2020]];
        [_keyLabels setupKey:0x24 withCharCodesArray:@[@0x00, @0x0037, @0x0026, @0x007B, @0x2021, @0x0037, @0x0026, @0x007B, @0x2021]];
        [_keyLabels setupKey:0x25 withCharCodesArray:@[@0x00, @0x0038, @0x002A, @0x007D, @0x2022, @0x0038, @0x002A, @0x007D, @0x2022]];
        [_keyLabels setupKey:0x26 withCharCodesArray:@[@0x00, @0x0039, @0x0028, @0x005B, @0x00B1, @0x0039, @0x0028, @0x005B, @0x00B1]];
        [_keyLabels setupKey:0x27 withCharCodesArray:@[@0x00, @0x0030, @0x0029, @0x005D, @0x2014, @0x0030, @0x0029, @0x005D, @0x2014]];
        [_keyLabels setupKey:0x2D withCharCodesArray:@[@0x00, @0x002D, @0x005F, @0x007C, @0x00BF, @0x002D, @0x005F, @0x007C, @0x00BF]];
        [_keyLabels setupKey:0x2E withCharCodesArray:@[@0x00, @0x003D, @0x002B, @0x00AC, @0x2013, @0x003D, @0x002B, @0x00AC, @0x2013]];
        [_keyLabels setupKey:0x2F withCharCodesArray:@[@0x77, @0x005E, @0x00A8, @0x0060, @0x201E, @0x005E, @0x00A8, @0x0060, @0x201E]];
        [_keyLabels setupKey:0x30 withCharCodesArray:@[@0x88, @0x00E7, @0x00C7, @0x007E, @0x007E, @0x00C7, @0x00C7, @0x007E, @0x007E]];
        [_keyLabels setupKey:0x31 withCharCodesArray:@[@0x88, @0x00E0, @0x00C0, @0x0060, @0x0060, @0x00C0, @0x00C0, @0x0060, @0x0060]];
        [_keyLabels setupKey:0x33 withCharCodesArray:@[@0x88, @0x003B, @0x003A, @0x00B0, @0x00B4, @0x003B, @0x003A, @0x00B0, @0x00B4]];
        [_keyLabels setupKey:0x34 withCharCodesArray:@[@0x00, @0x00E8, @0x00C8, @0x005C, @0x2019, @0x00C8, @0x00C8, @0x005C, @0x2019]];
        [_keyLabels setupKey:0x35 withCharCodesArray:@[@0x00, @0x002F, @0x005C, @0x007C, @0x0020, @0x002F, @0x005C, @0x007C, @0x0020]];
        [_keyLabels setupKey:0x36 withCharCodesArray:@[@0x00, @0x002C, @0x0027, @0x003C, @0x0078, @0x002C, @0x0027, @0x003C, @0x0078]];
        [_keyLabels setupKey:0x37 withCharCodesArray:@[@0x00, @0x002E, @0x0022, @0x003E, @0x00F7, @0x002E, @0x0022, @0x003E, @0x00F7]];
        [_keyLabels setupKey:0x38 withCharCodesArray:@[@0x00, @0x00E9, @0x00C9, @0x002F, @0x2260, @0x00C9, @0x00C9, @0x002F, @0x2260]];
        [_keyLabels setupKey:0x64 withCharCodesArray:@[@0x00, @0x00F9, @0x00D9, @0x005C, @0x03A9, @0x00D9, @0x00D9, @0x005C, @0x03A9]];
    }
    return _keyLabels;
}
