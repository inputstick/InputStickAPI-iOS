...
@interface InputStickKeyboardLayoutDeCHLinux () {
...
@implementation InputStickKeyboardLayoutDeCHLinux
...
- (NSString *)layoutFullName {
    return @"German (Deutsch) [CH Linux]";
}
...
- (InputStickKeyboardKeyModel *)keyModelForCharacter:(int)character {
    ...
    switch (character) {
            ...
            case 471: // Ǘ
                ...
                break;
            case 472: // ǘ
                keyboardKeyModel = [[InputStickKeyboardKeyModel alloc]initWithUnicodeCharacter:character key:47 modifiers:0 deadkey:45 deadkeyModifiers:64];
                break;
            case 473: // Ǚ
            ...
            case 7847: // ầ
                ...
                break;
            case 7857: // ằ
                keyboardKeyModel = [[InputStickKeyboardKeyModel alloc]initWithUnicodeCharacter:character key:52 modifiers:2 deadkey:49 deadkeyModifiers:66];
                break;
            case 7864: // Ẹ
...
- (InputStickKeyLabels *)keyLabels {
    if (_keyLabels == nil) {
        ...
        [_keyLabels setupKey:0x2F withCharCodesArray:@[@0x88, @0x00FC, @0x00E8, @0x005B, @0x00B0, @0x00DC, @0x00C8, @0x005B, @0x00B0]];
        ...
        [_keyLabels setupKey:0x33 withCharCodesArray:@[@0xCC, @0x00F6, @0x00E9, @0x0027, @0x02DD, @0x00D6, @0x00C9, @0x0027, @0x02DD]];
        [_keyLabels setupKey:0x34 withCharCodesArray:@[@0x88, @0x00E4, @0x00E0, @0x007B, @0x02C7, @0x00C4, @0x00C0, @0x007B, @0x02C7]];
