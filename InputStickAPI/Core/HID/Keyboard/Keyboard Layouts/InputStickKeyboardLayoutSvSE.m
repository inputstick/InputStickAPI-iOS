...
static NSString *const LocaleName =  @"sv-SE";
static NSString *const NativeName =  @"Svenska";
static NSString *const EnglishName = @"Swedish";
static NSString *const Variant =     @"SE";
