...
@interface InputStickKeyboardLayoutEnUSInt () {
...
@implementation InputStickKeyboardLayoutEnUSInt
...
- (NSString *)layoutFullName {
    return @"English (English) [US International]";
}
...
- (NSString *)availableCharactersString {
    //\t\n !"#$%&'()*+,-./0123456789:;<=>?@ABCDEFGHIJKLMNOPQRSTUVWXYZ[\]^_`abcdefghijklmnopqrstuvwxyz{|}~¡¢£¤¥¦§¨©«¬®°²³´µ¶¹»¼½¾¿ÀÁÂÃÄÅÆÇÈÉÊËÌÍÎÏÐÑÒÓÔÕÖ×ØÙÚÛÜÝÞßàáâãäåæçèéêëìíîïðñòóôõö÷øùúûüýþÿ‘’€
    return @"\t\n !\"#$%&\'()*+,-./0123456789:;<=>?@ABCDEFGHIJKLMNOPQRSTUVWXYZ[\\]^_`abcdefghijklmnopqrstuvwxyz{|}~\u00A1\u00A2\u00A3\u00A4\u00A5\u00A6\u00A7\u00A8\u00A9\u00AB\u00AC\u00AE\u00B0\u00B2\u00B3\u00B4\u00B5\u00B6\u00B9\u00BB\u00BC\u00BD\u00BE\u00BF\u00C0\u00C1\u00C2\u00C3\u00C4\u00C5\u00C6\u00C7\u00C8\u00C9\u00CA\u00CB\u00CC\u00CD\u00CE\u00CF\u00D0\u00D1\u00D2\u00D3\u00D4\u00D5\u00D6\u00D7\u00D8\u00D9\u00DA\u00DB\u00DC\u00DD\u00DE\u00DF\u00E0\u00E1\u00E2\u00E3\u00E4\u00E5\u00E6\u00E7\u00E8\u00E9\u00EA\u00EB\u00EC\u00ED\u00EE\u00EF\u00F0\u00F1\u00F2\u00F3\u00F4\u00F5\u00F6\u00F7\u00F8\u00F9\u00FA\u00FB\u00FC\u00FD\u00FE\u00FF\u2018\u2019\u20AC";
}
...
- (InputStickKeyLabels *)keyLabels {
    if (_keyLabels == nil) {
        ...
        [_keyLabels setupKey:0x15 withCharCodesArray:@[@0x00, @0x0072, @0x0052, @0x00AE, @0x0000, @0x0052, @0x0072, @0x00AE, @0x0000]];
        ...
        [_keyLabels setupKey:0x23 withCharCodesArray:@[@0x22, @0x0036, @0x005E, @0x00BC, @0x0000, @0x0036, @0x005E, @0x00BC, @0x0000]];
        [_keyLabels setupKey:0x24 withCharCodesArray:@[@0x00, @0x0037, @0x0026, @0x00BD, @0x0000, @0x0037, @0x0026, @0x00BD, @0x0000]];
        [_keyLabels setupKey:0x25 withCharCodesArray:@[@0x00, @0x0038, @0x002A, @0x00BE, @0x0000, @0x0038, @0x002A, @0x00BE, @0x0000]];
        [_keyLabels setupKey:0x26 withCharCodesArray:@[@0x00, @0x0039, @0x0028, @0x2018, @0x0000, @0x0039, @0x0028, @0x2018, @0x0000]];
        [_keyLabels setupKey:0x27 withCharCodesArray:@[@0x00, @0x0030, @0x0029, @0x2019, @0x0000, @0x0030, @0x0029, @0x2019, @0x0000]];
        [_keyLabels setupKey:0x2D withCharCodesArray:@[@0x00, @0x002D, @0x005F, @0x00A5, @0x0000, @0x002D, @0x005F, @0x00A5, @0x0000]];
        ...
        [_keyLabels setupKey:0x34 withCharCodesArray:@[@0x33, @0x0027, @0x0022, @0x00B4, @0x00A8, @0x0027, @0x0022, @0x00B4, @0x00A8]];
        [_keyLabels setupKey:0x35 withCharCodesArray:@[@0x33, @0x0060, @0x007E, @0x0000, @0x0000, @0x0060, @0x007E, @0x0000, @0x0000]];
        [_keyLabels setupKey:0x36 withCharCodesArray:@[@0x00, @0x002C, @0x003C, @0x00E7, @0x00C7, @0x002C, @0x003C, @0x00C7, @0x00E7]];
        [_keyLabels setupKey:0x37 withCharCodesArray:@[@0x00, @0x002E, @0x003E, @0x0000, @0x0000, @0x002E, @0x003E, @0x0000, @0x0000]];
        [_keyLabels setupKey:0x38 withCharCodesArray:@[@0x00, @0x002F, @0x003F, @0x00BF, @0x0000, @0x002F, @0x003F, @0x00BF, @0x0000]];
    }
    return _keyLabels;
}
