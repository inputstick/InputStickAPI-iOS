...
static NSString *const LocaleName =  @"en-US-int";
static NSString *const NativeName =  @"English";
static NSString *const EnglishName = @"English";
static NSString *const Variant =     @"US International";
...
+ (NSMutableArray<NSNumber *> *)getAvailableCharacters {
    ...
    [array addObject:[NSNumber numberWithInteger:254]];
    [array addObject:[NSNumber numberWithInteger:255]];
    [array addObject:[NSNumber numberWithInteger:8216]];
    [array addObject:[NSNumber numberWithInteger:8217]];
