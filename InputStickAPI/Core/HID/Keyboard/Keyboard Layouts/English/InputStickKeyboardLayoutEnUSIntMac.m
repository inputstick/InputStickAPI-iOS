...
@interface InputStickKeyboardLayoutEnUSIntMac () {
...
@implementation InputStickKeyboardLayoutEnUSIntMac

- (NSString *)layoutCode {
    return @"en-US-int-mac";
}
...
- (NSString *)layoutVariant {
    return @"US International macOS";
}

- (NSString *)layoutFullName {
    return @"English (English) [US International macOS]";
}
...
- (InputStickKeyboardKeyModel *)keyModelForCharacter:(int)character {
    ...
    switch (character) {
            ...
            case 207: // Ï
                ...
                break;
            case 209: // Ñ
                keyboardKeyModel = [[InputStickKeyboardKeyModel alloc]initWithUnicodeCharacter:character key:17 modifiers:2 deadkey:53 deadkeyModifiers:2];
                break;
            case 210: // Ò
            ...
            case 239: // ï
                ...
                break;
            case 241: // ñ
                keyboardKeyModel = [[InputStickKeyboardKeyModel alloc]initWithUnicodeCharacter:character key:17 modifiers:0 deadkey:53 deadkeyModifiers:2];
                break;
            case 242: // ò
...
- (InputStickKeyLabels *)keyLabels {
    if (_keyLabels == nil) {
        ...
        [_keyLabels setupKey:0x0C withCharCodesArray:@[@0x04, @0x0069, @0x0049, @0x005E, @0x02C6, @0x0049, @0x0049, @0x02C6, @0x02C6]];
        ...
        [_keyLabels setupKey:0x11 withCharCodesArray:@[@0x04, @0x006E, @0x004E, @0x007E, @0x02DC, @0x004E, @0x004E, @0x02DC, @0x02DC]];
        ...
        [_keyLabels setupKey:0x23 withCharCodesArray:@[@0x22, @0x0036, @0x005E, @0x00A7, @0xFB02, @0x0036, @0x005E, @0x00A7, @0xFB02]];
        ...
        [_keyLabels setupKey:0x34 withCharCodesArray:@[@0x33, @0x0027, @0x0022, @0x00E6, @0x00C6, @0x0027, @0x0022, @0x00C6, @0x00C6]];
        [_keyLabels setupKey:0x35 withCharCodesArray:@[@0x37, @0x0060, @0x007E, @0x0060, @0x0060, @0x0060, @0x007E, @0x0060, @0x0060]];
