...
@interface InputStickKeyboardLayoutDaDKLinux () {
...
@implementation InputStickKeyboardLayoutDaDKLinux
...
- (InputStickKeyboardKeyModel *)keyModelForCharacter:(int)character {
    ...
    switch (character) {
            ...
            case 507: // ǻ
                ...
                break;
            case 508: // Ǽ
                keyboardKeyModel = [[InputStickKeyboardKeyModel alloc]initWithUnicodeCharacter:character key:51 modifiers:2 deadkey:46 deadkeyModifiers:0];
                break;
            case 509: // ǽ
                ...
                break;
            case 510: // Ǿ
                keyboardKeyModel = [[InputStickKeyboardKeyModel alloc]initWithUnicodeCharacter:character key:52 modifiers:2 deadkey:46 deadkeyModifiers:0];
                break;
            case 511: // ǿ
                keyboardKeyModel = [[InputStickKeyboardKeyModel alloc]initWithUnicodeCharacter:character key:52 modifiers:0 deadkey:46 deadkeyModifiers:0];
                break;
            case 542: // Ȟ
...
- (NSString *)availableCharactersString {
    //\t\n !"#$%&'()*+,-./0123456789:;<=>?@ABCDEFGHIJKLMNOPQRSTUVWXYZ[\]^_`abcdefghijklmnopqrstuvwxyz{|}~¡¢£¤¥¦§©ª«¬®°±²³µ¶·¸¹º»¼½¾¿ÀÁÂÃÄÅÆÇÈÉÊËÌÍÎÏÐÑÒÓÔÕÖ×ØÙÚÛÜÝÞßàáâãäåæçèéêëìíîïðñòóôõö÷øùúûüýþÿĄąĆćĈĉĊċČčĎďđĖėĘęĚěĜĝĠġĢģĤĥĦħĨĩĮįİıĴĵĶķĸĹĺĻļĽľĿŀŁłŃńŅņŇňŊŋŐőŒœŔŕŖŗŘřŚśŜŝŞşŠšŢţŤťŨũŮůŰűŲųŴŵŶŷŸŹźŻżŽžƁƇƈƊƑƒƓƘƙƝƠơƤƥƬƭƯưƲǍǎǏǐǑǒǓǔǗǘǙǚǛǜǦǧǨǩǪǫǰǴǵǸǹǺǻǼǽǾǿȞȟȤȥȦȧȨȩȮȯȷɓɗɠɦɱɲɼʂʋʠˇ˙˛˝̛̣̉̈́ΏΩḂḃḄḅḊḋḌḍḐḑḞḟḢḣḤḥḦḧḨḩḰḱḲḳḶḷḾḿṀṁṂṃṄṅṆṇṔṕṖṗṘṙṚṛṠṡṢṣṪṫṬṭṼṽṾṿẀẁẂẃẄẅẆẇẈẉẊẋẌẍẎẏẐẑẒẓẗẘẙẠạẢảẸẹẺẻẼẽỈỉỊịỌọỎỏỤụỦủỲỳỴỵỶỷỸỹῺ‘’“”⁰⁴⁵⁶⁷⁸⁹⁺⁻⁼⁽⁾₀₁₂₃₄₅₆₇₈₉₊₋₌₍₎€₵⅝←↑→↓≃≲≳⨥⨪⩦ⱮⱲⱳ
    return @"\t\n !\"#$%&\'()*+,-./0123456789:;<=>?@ABCDEFGHIJKLMNOPQRSTUVWXYZ[\\]^_`abcdefghijklmnopqrstuvwxyz{|}~\u00A1\u00A2\u00A3\u00A4\u00A5\u00A6\u00A7\u00A9\u00AA\u00AB\u00AC\u00AE\u00B0\u00B1\u00B2\u00B3\u00B5\u00B6\u00B7\u00B8\u00B9\u00BA\u00BB\u00BC\u00BD\u00BE\u00BF\u00C0\u00C1\u00C2\u00C3\u00C4\u00C5\u00C6\u00C7\u00C8\u00C9\u00CA\u00CB\u00CC\u00CD\u00CE\u00CF\u00D0\u00D1\u00D2\u00D3\u00D4\u00D5\u00D6\u00D7\u00D8\u00D9\u00DA\u00DB\u00DC\u00DD\u00DE\u00DF\u00E0\u00E1\u00E2\u00E3\u00E4\u00E5\u00E6\u00E7\u00E8\u00E9\u00EA\u00EB\u00EC\u00ED\u00EE\u00EF\u00F0\u00F1\u00F2\u00F3\u00F4\u00F5\u00F6\u00F7\u00F8\u00F9\u00FA\u00FB\u00FC\u00FD\u00FE\u00FF\u0104\u0105\u0106\u0107\u0108\u0109\u010A\u010B\u010C\u010D\u010E\u010F\u0111\u0116\u0117\u0118\u0119\u011A\u011B\u011C\u011D\u0120\u0121\u0122\u0123\u0124\u0125\u0126\u0127\u0128\u0129\u012E\u012F\u0130\u0131\u0134\u0135\u0136\u0137\u0138\u0139\u013A\u013B\u013C\u013D\u013E\u013F\u0140\u0141\u0142\u0143\u0144\u0145\u0146\u0147\u0148\u014A\u014B\u0150\u0151\u0152\u0153\u0154\u0155\u0156\u0157\u0158\u0159\u015A\u015B\u015C\u015D\u015E\u015F\u0160\u0161\u0162\u0163\u0164\u0165\u0168\u0169\u016E\u016F\u0170\u0171\u0172\u0173\u0174\u0175\u0176\u0177\u0178\u0179\u017A\u017B\u017C\u017D\u017E\u0181\u0187\u0188\u018A\u0191\u0192\u0193\u0198\u0199\u019D\u01A0\u01A1\u01A4\u01A5\u01AC\u01AD\u01AF\u01B0\u01B2\u01CD\u01CE\u01CF\u01D0\u01D1\u01D2\u01D3\u01D4\u01D7\u01D8\u01D9\u01DA\u01DB\u01DC\u01E6\u01E7\u01E8\u01E9\u01EA\u01EB\u01F0\u01F4\u01F5\u01F8\u01F9\u01FA\u01FB\u01FC\u01FD\u01FE\u01FF\u021E\u021F\u0224\u0225\u0226\u0227\u0228\u0229\u022E\u022F\u0237\u0253\u0257\u0260\u0266\u0271\u0272\u027C\u0282\u028B\u02A0\u02C7\u02D9\u02DB\u02DD\u0309\u031B\u0323\u0344\u038F\u03A9\u1E02\u1E03\u1E04\u1E05\u1E0A\u1E0B\u1E0C\u1E0D\u1E10\u1E11\u1E1E\u1E1F\u1E22\u1E23\u1E24\u1E25\u1E26\u1E27\u1E28\u1E29\u1E30\u1E31\u1E32\u1E33\u1E36\u1E37\u1E3E\u1E3F\u1E40\u1E41\u1E42\u1E43\u1E44\u1E45\u1E46\u1E47\u1E54\u1E55\u1E56\u1E57\u1E58\u1E59\u1E5A\u1E5B\u1E60\u1E61\u1E62\u1E63\u1E6A\u1E6B\u1E6C\u1E6D\u1E7C\u1E7D\u1E7E\u1E7F\u1E80\u1E81\u1E82\u1E83\u1E84\u1E85\u1E86\u1E87\u1E88\u1E89\u1E8A\u1E8B\u1E8C\u1E8D\u1E8E\u1E8F\u1E90\u1E91\u1E92\u1E93\u1E97\u1E98\u1E99\u1EA0\u1EA1\u1EA2\u1EA3\u1EB8\u1EB9\u1EBA\u1EBB\u1EBC\u1EBD\u1EC8\u1EC9\u1ECA\u1ECB\u1ECC\u1ECD\u1ECE\u1ECF\u1EE4\u1EE5\u1EE6\u1EE7\u1EF2\u1EF3\u1EF4\u1EF5\u1EF6\u1EF7\u1EF8\u1EF9\u1FFA\u2018\u2019\u201C\u201D\u2070\u2074\u2075\u2076\u2077\u2078\u2079\u207A\u207B\u207C\u207D\u207E\u2080\u2081\u2082\u2083\u2084\u2085\u2086\u2087\u2088\u2089\u208A\u208B\u208C\u208D\u208E\u20AC\u20B5\u215D\u2190\u2191\u2192\u2193\u2243\u2272\u2273\u2A25\u2A2A\u2A66\u2C6E\u2C72\u2C73";
}
...
- (InputStickKeyLabels *)keyLabels {
    if (_keyLabels == nil) {
        ...
        [_keyLabels setupKey:0x22 withCharCodesArray:@[@0x00, @0x0035, @0x0025, @0x00BD, @0x00A2, @0x0035, @0x0025, @0x00BD, @0x00A2]];
        ...
        [_keyLabels setupKey:0x2E withCharCodesArray:@[@0x33, @0x0027, @0x0060, @0x007C, @0x00A6, @0x0027, @0x0060, @0x007C, @0x00A6]];
        ...
        [_keyLabels setupKey:0x31 withCharCodesArray:@[@0x44, @0x0027, @0x002A, @0x02DD, @0x00D7, @0x0027, @0x002A, @0x02DD, @0x00D7]];
        [_keyLabels setupKey:0x33 withCharCodesArray:@[@0xCC, @0x00E6, @0x00C6, @0x0027, @0x02DD, @0x00C6, @0x00E6, @0x0027, @0x02DD]];
        [_keyLabels setupKey:0x34 withCharCodesArray:@[@0xCC, @0x00F8, @0x00D8, @0x005E, @0x02C7, @0x00D8, @0x00F8, @0x005E, @0x02C7]];
        [_keyLabels setupKey:0x35 withCharCodesArray:@[@0x00, @0x00BD, @0x00A7, @0x00BE, @0x00B6, @0x00BD, @0x00A7, @0x00BE, @0x00B6]];
        ...
        [_keyLabels setupKey:0x64 withCharCodesArray:@[@0x00, @0x003C, @0x003E, @0x005C, @0x00AC, @0x003C, @0x003E, @0x005C, @0x00AC]];
    }
    return _keyLabels;
}
