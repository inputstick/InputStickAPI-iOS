...
static NSString *const LocaleName =  @"nl-NL";
static NSString *const NativeName =  @"Nederlands";
static NSString *const EnglishName = @"Dutch";
static NSString *const Variant =     @"NL";
