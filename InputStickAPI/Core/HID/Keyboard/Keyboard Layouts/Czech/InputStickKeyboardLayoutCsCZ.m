...
@interface InputStickKeyboardLayoutCsCZ () {
...
- (NSString *)availableCharactersString {
    //\t\n !"#$%&'()*+,-./0123456789:;<=>?@ABCDEFGHIJKLMNOPQRSTUVWXYZ[\]^_`abcdefghijklmnopqrstuvwxyz{|}~¤§¨°´·¸ÀÁÂÄÅÇÈÉÊËÌÍÎÏÒÓÔÖ×ÙÚÛÜÝßàáâäåçèéêëìíîïòóôö÷ùúûüýÿĂăĄąĆćČčĎďĐđĖėĘęĚěĞğĢģĮįİıĶķĹĺĻļĽľŁłŃńŅņŇňŐőŔŕŖŗŘřŚśŞşŠšŢţŤťŮůŰűŲųŸŹźŻżŽžˇ˘˛˝€
    return @"\t\n !\"#$%&\'()*+,-./0123456789:;<=>?@ABCDEFGHIJKLMNOPQRSTUVWXYZ[\\]^_`abcdefghijklmnopqrstuvwxyz{|}~\u00A4\u00A7\u00A8\u00B0\u00B4\u00B7\u00B8\u00C0\u00C1\u00C2\u00C4\u00C5\u00C7\u00C8\u00C9\u00CA\u00CB\u00CC\u00CD\u00CE\u00CF\u00D2\u00D3\u00D4\u00D6\u00D7\u00D9\u00DA\u00DB\u00DC\u00DD\u00DF\u00E0\u00E1\u00E2\u00E4\u00E5\u00E7\u00E8\u00E9\u00EA\u00EB\u00EC\u00ED\u00EE\u00EF\u00F2\u00F3\u00F4\u00F6\u00F7\u00F9\u00FA\u00FB\u00FC\u00FD\u00FF\u0102\u0103\u0104\u0105\u0106\u0107\u010C\u010D\u010E\u010F\u0110\u0111\u0116\u0117\u0118\u0119\u011A\u011B\u011E\u011F\u0122\u0123\u012E\u012F\u0130\u0131\u0136\u0137\u0139\u013A\u013B\u013C\u013D\u013E\u0141\u0142\u0143\u0144\u0145\u0146\u0147\u0148\u0150\u0151\u0154\u0155\u0156\u0157\u0158\u0159\u015A\u015B\u015E\u015F\u0160\u0161\u0162\u0163\u0164\u0165\u016E\u016F\u0170\u0171\u0172\u0173\u0178\u0179\u017A\u017B\u017C\u017D\u017E\u02C7\u02D8\u02DB\u02DD\u20AC";
}
...
- (InputStickKeyLabels *)keyLabels {
    if (_keyLabels == nil) {
        ...
        [_keyLabels setupKey:0x1F withCharCodesArray:@[@0x44, @0x011B, @0x0032, @0x02C7, @0x0000, @0x011A, @0x0032, @0x02C7, @0x0000]];
        [_keyLabels setupKey:0x20 withCharCodesArray:@[@0x44, @0x0161, @0x0033, @0x005E, @0x0000, @0x0160, @0x0033, @0x005E, @0x0000]];
        [_keyLabels setupKey:0x21 withCharCodesArray:@[@0x44, @0x010D, @0x0034, @0x02D8, @0x0000, @0x010C, @0x0034, @0x02D8, @0x0000]];
        [_keyLabels setupKey:0x22 withCharCodesArray:@[@0x44, @0x0159, @0x0035, @0x00B0, @0x0000, @0x0158, @0x0035, @0x00B0, @0x0000]];
        [_keyLabels setupKey:0x23 withCharCodesArray:@[@0x44, @0x017E, @0x0036, @0x02DB, @0x0000, @0x017D, @0x0036, @0x02DB, @0x0000]];
        [_keyLabels setupKey:0x24 withCharCodesArray:@[@0x44, @0x00FD, @0x0037, @0x0060, @0x0000, @0x00DD, @0x0037, @0x0060, @0x0000]];
        [_keyLabels setupKey:0x25 withCharCodesArray:@[@0x44, @0x00E1, @0x0038, @0x00B7, @0x0000, @0x00C1, @0x0038, @0x00B7, @0x0000]];
        [_keyLabels setupKey:0x26 withCharCodesArray:@[@0x44, @0x00ED, @0x0039, @0x00B4, @0x0000, @0x00CD, @0x0039, @0x00B4, @0x0000]];
        [_keyLabels setupKey:0x27 withCharCodesArray:@[@0x44, @0x00E9, @0x0030, @0x02DD, @0x0000, @0x00C9, @0x0030, @0x02DD, @0x0000]];
        [_keyLabels setupKey:0x2D withCharCodesArray:@[@0x44, @0x003D, @0x0025, @0x00A8, @0x0000, @0x003D, @0x0025, @0x00A8, @0x0000]];
        [_keyLabels setupKey:0x2E withCharCodesArray:@[@0x77, @0x00B4, @0x02C7, @0x00B8, @0x0000, @0x00B4, @0x02C7, @0x00B8, @0x0000]];
        [_keyLabels setupKey:0x2F withCharCodesArray:@[@0x00, @0x00FA, @0x002F, @0x00F7, @0x0000, @0x00DA, @0x002F, @0x00F7, @0x0000]];
        [_keyLabels setupKey:0x30 withCharCodesArray:@[@0x00, @0x0029, @0x0028, @0x00D7, @0x0000, @0x0029, @0x0028, @0x00D7, @0x0000]];
        [_keyLabels setupKey:0x31 withCharCodesArray:@[@0x11, @0x00A8, @0x0027, @0x00A4, @0x0000, @0x00A8, @0x0027, @0x00A4, @0x0000]];
        [_keyLabels setupKey:0x33 withCharCodesArray:@[@0x00, @0x016F, @0x0022, @0x0024, @0x0000, @0x016E, @0x0022, @0x0024, @0x0000]];
        [_keyLabels setupKey:0x34 withCharCodesArray:@[@0x00, @0x00A7, @0x0021, @0x00DF, @0x0000, @0x00A7, @0x0021, @0x00DF, @0x0000]];
        [_keyLabels setupKey:0x35 withCharCodesArray:@[@0x22, @0x003B, @0x00B0, @0x0000, @0x0000, @0x003B, @0x00B0, @0x0000, @0x0000]];
        [_keyLabels setupKey:0x36 withCharCodesArray:@[@0x00, @0x002C, @0x003F, @0x003C, @0x0000, @0x002C, @0x003F, @0x003C, @0x0000]];
