...
@interface InputStickKeyboardLayoutCsCZQwertyMac () {
...
@implementation InputStickKeyboardLayoutCsCZQwertyMac

- (NSString *)layoutCode {
    return @"cs-CZ-qwerty-mac";
}
...
- (NSString *)layoutVariant {
    return @"CZ qwerty macOS";
}

- (NSString *)layoutDisplayName {
    return @"Czech, CZ qwerty macOS";
}
...
- (NSString *)availableCharactersString {
    //\t\n !"#$%&'()*+,-./0123456789:;<=>?@ABCDEFGHIJKLMNOPQRSTUVWXYZ[\]^_`abcdefghijklmnopqrstuvwxyz{|}~£§¨©«¬®°¶»ÁÄÉÍÓÔÕÖÚÜÝßáäéíóôõö÷úüýĀāĄąĆćČčĎďĒēĖėĘęĚěĢģĪīĮįĶķĹĺĻļĽľŁłŃńŅņŇňŌōŐőŔŕŖŗŘřŚśŠšŤťŪūŮůŰűŲųŹźŻżŽžˇ–—‘’‚“”„†•…‹›€™∂∆∑√≠≤≥◊
    return @"\t\n !\"#$%&\'()*+,-./0123456789:;<=>?@ABCDEFGHIJKLMNOPQRSTUVWXYZ[\\]^_`abcdefghijklmnopqrstuvwxyz{|}~\u00A3\u00A7\u00A8\u00A9\u00AB\u00AC\u00AE\u00B0\u00B6\u00BB\u00C1\u00C4\u00C9\u00CD\u00D3\u00D4\u00D5\u00D6\u00DA\u00DC\u00DD\u00DF\u00E1\u00E4\u00E9\u00ED\u00F3\u00F4\u00F5\u00F6\u00F7\u00FA\u00FC\u00FD\u0100\u0101\u0104\u0105\u0106\u0107\u010C\u010D\u010E\u010F\u0112\u0113\u0116\u0117\u0118\u0119\u011A\u011B\u0122\u0123\u012A\u012B\u012E\u012F\u0136\u0137\u0139\u013A\u013B\u013C\u013D\u013E\u0141\u0142\u0143\u0144\u0145\u0146\u0147\u0148\u014C\u014D\u0150\u0151\u0154\u0155\u0156\u0157\u0158\u0159\u015A\u015B\u0160\u0161\u0164\u0165\u016A\u016B\u016E\u016F\u0170\u0171\u0172\u0173\u0179\u017A\u017B\u017C\u017D\u017E\u02C7\u2013\u2014\u2018\u2019\u201A\u201C\u201D\u201E\u2020\u2022\u2026\u2039\u203A\u20AC\u2122\u2202\u2206\u2211\u221A\u2260\u2264\u2265\u25CA";
}
...
- (InputStickKeyLabels *)keyLabels {
    if (_keyLabels == nil) {
        ...
        [_keyLabels setupKey:0x04 withCharCodesArray:@[@0x00, @0x0061, @0x0041, @0x0105, @0x0104, @0x0041, @0x0041, @0x0104, @0x0104]];
        [_keyLabels setupKey:0x05 withCharCodesArray:@[@0x00, @0x0062, @0x0042, @0x0000, @0x0000, @0x0042, @0x0042, @0x0000, @0x0000]];
        [_keyLabels setupKey:0x06 withCharCodesArray:@[@0x00, @0x0063, @0x0043, @0x0000, @0x00A9, @0x0043, @0x0043, @0x0000, @0x00A9]];
        [_keyLabels setupKey:0x07 withCharCodesArray:@[@0x00, @0x0064, @0x0044, @0x2202, @0x2206, @0x0044, @0x0044, @0x2206, @0x2206]];
        [_keyLabels setupKey:0x08 withCharCodesArray:@[@0x00, @0x0065, @0x0045, @0x0119, @0x0118, @0x0045, @0x0045, @0x0118, @0x0118]];
        [_keyLabels setupKey:0x09 withCharCodesArray:@[@0x00, @0x0066, @0x0046, @0x0000, @0x0000, @0x0046, @0x0046, @0x0000, @0x0000]];
        [_keyLabels setupKey:0x0A withCharCodesArray:@[@0x00, @0x0067, @0x0047, @0x0000, @0x0000, @0x0047, @0x0047, @0x0000, @0x0000]];
        [_keyLabels setupKey:0x0B withCharCodesArray:@[@0x00, @0x0068, @0x0048, @0x2018, @0x201C, @0x0048, @0x0048, @0x2018, @0x201C]];
        [_keyLabels setupKey:0x0C withCharCodesArray:@[@0x00, @0x0069, @0x0049, @0x0000, @0x0000, @0x0049, @0x0049, @0x0000, @0x0000]];
        [_keyLabels setupKey:0x0D withCharCodesArray:@[@0x00, @0x006A, @0x004A, @0x2019, @0x201D, @0x004A, @0x004A, @0x2019, @0x201D]];
        [_keyLabels setupKey:0x0E withCharCodesArray:@[@0x00, @0x006B, @0x004B, @0x0000, @0x0000, @0x004B, @0x004B, @0x0000, @0x0000]];
        [_keyLabels setupKey:0x0F withCharCodesArray:@[@0x00, @0x006C, @0x004C, @0x0142, @0x0141, @0x004C, @0x004C, @0x0141, @0x0141]];
        [_keyLabels setupKey:0x10 withCharCodesArray:@[@0x00, @0x006D, @0x004D, @0x0000, @0x0000, @0x004D, @0x004D, @0x0000, @0x0000]];
        [_keyLabels setupKey:0x11 withCharCodesArray:@[@0x00, @0x006E, @0x004E, @0x201A, @0x201E, @0x004E, @0x004E, @0x201A, @0x201E]];
        [_keyLabels setupKey:0x12 withCharCodesArray:@[@0x00, @0x006F, @0x004F, @0x0000, @0x0000, @0x004F, @0x004F, @0x0000, @0x0000]];
        [_keyLabels setupKey:0x13 withCharCodesArray:@[@0x00, @0x0070, @0x0050, @0x0000, @0x0000, @0x0050, @0x0050, @0x0000, @0x0000]];
        [_keyLabels setupKey:0x14 withCharCodesArray:@[@0x00, @0x0071, @0x0051, @0x0000, @0x0000, @0x0051, @0x0051, @0x0000, @0x0000]];
        [_keyLabels setupKey:0x15 withCharCodesArray:@[@0x00, @0x0072, @0x0052, @0x20AC, @0x00AE, @0x0052, @0x0052, @0x0000, @0x00AE]];
        [_keyLabels setupKey:0x16 withCharCodesArray:@[@0x00, @0x0073, @0x0053, @0x00DF, @0x2211, @0x0053, @0x0053, @0x2211, @0x2211]];
        [_keyLabels setupKey:0x17 withCharCodesArray:@[@0x00, @0x0074, @0x0054, @0x0000, @0x2122, @0x0054, @0x0054, @0x0000, @0x2122]];
        [_keyLabels setupKey:0x18 withCharCodesArray:@[@0x00, @0x0075, @0x0055, @0x0000, @0x0000, @0x0055, @0x0055, @0x0000, @0x0000]];
        [_keyLabels setupKey:0x19 withCharCodesArray:@[@0x00, @0x0076, @0x0056, @0x0000, @0x221A, @0x0056, @0x0056, @0x0000, @0x221A]];
        [_keyLabels setupKey:0x1A withCharCodesArray:@[@0x00, @0x0077, @0x0057, @0x0117, @0x0116, @0x0057, @0x0057, @0x0116, @0x0116]];
        [_keyLabels setupKey:0x1B withCharCodesArray:@[@0x00, @0x0078, @0x0058, @0x0000, @0x0000, @0x0058, @0x0058, @0x0000, @0x0000]];
        [_keyLabels setupKey:0x1C withCharCodesArray:@[@0x00, @0x0079, @0x0059, @0x0000, @0x0000, @0x0059, @0x0059, @0x0000, @0x0000]];
        [_keyLabels setupKey:0x1D withCharCodesArray:@[@0x00, @0x007A, @0x005A, @0x017C, @0x017B, @0x005A, @0x005A, @0x0000, @0x017B]];
        [_keyLabels setupKey:0x1E withCharCodesArray:@[@0x00, @0x002B, @0x0031, @0x0060, @0x00AC, @0x002B, @0x0031, @0x0060, @0x00AC]];
        [_keyLabels setupKey:0x1F withCharCodesArray:@[@0x00, @0x011B, @0x0032, @0x0040, @0x2022, @0x011A, @0x0032, @0x0040, @0x2022]];
        [_keyLabels setupKey:0x20 withCharCodesArray:@[@0x00, @0x0161, @0x0033, @0x0023, @0x2260, @0x0160, @0x0033, @0x0023, @0x2260]];
        [_keyLabels setupKey:0x21 withCharCodesArray:@[@0x00, @0x010D, @0x0034, @0x0024, @0x00A3, @0x010C, @0x0034, @0x0024, @0x00A3]];
        [_keyLabels setupKey:0x22 withCharCodesArray:@[@0x00, @0x0159, @0x0035, @0x007E, @0x25CA, @0x0158, @0x0035, @0x007E, @0x25CA]];
        [_keyLabels setupKey:0x23 withCharCodesArray:@[@0x00, @0x017E, @0x0036, @0x005E, @0x2020, @0x017D, @0x0036, @0x005E, @0x2020]];
        [_keyLabels setupKey:0x24 withCharCodesArray:@[@0x00, @0x00FD, @0x0037, @0x0026, @0x00B6, @0x00DD, @0x0037, @0x0026, @0x00B6]];
        [_keyLabels setupKey:0x25 withCharCodesArray:@[@0x00, @0x00E1, @0x0038, @0x002A, @0x00F7, @0x00C1, @0x0038, @0x002A, @0x00F7]];
        [_keyLabels setupKey:0x26 withCharCodesArray:@[@0x00, @0x00ED, @0x0039, @0x007B, @0x00AB, @0x00CD, @0x0039, @0x007B, @0x00AB]];
        [_keyLabels setupKey:0x27 withCharCodesArray:@[@0x00, @0x00E9, @0x0030, @0x007D, @0x00BB, @0x00C9, @0x0030, @0x007D, @0x00BB]];
        [_keyLabels setupKey:0x2D withCharCodesArray:@[@0xCC, @0x003D, @0x0025, @0x00B0, @0x002C, @0x003D, @0x0025, @0x00B0, @0x002C]];
        [_keyLabels setupKey:0x2E withCharCodesArray:@[@0xFF, @0x0027, @0x02C7, @0x005E, @0x002D, @0x0027, @0x02C7, @0x005E, @0x002D]];
        [_keyLabels setupKey:0x2F withCharCodesArray:@[@0x00, @0x00FA, @0x002F, @0x005B, @0x2039, @0x00DA, @0x002F, @0x005B, @0x2039]];
        [_keyLabels setupKey:0x30 withCharCodesArray:@[@0x00, @0x0029, @0x0028, @0x005D, @0x203A, @0x0029, @0x0028, @0x005D, @0x203A]];
        [_keyLabels setupKey:0x31 withCharCodesArray:@[@0xDD, @0x00A8, @0x0060, @0x00A8, @0x0022, @0x00A8, @0x0060, @0x00A8, @0x0022]];
        [_keyLabels setupKey:0x33 withCharCodesArray:@[@0x00, @0x016F, @0x0022, @0x003B, @0x2026, @0x016E, @0x0022, @0x003B, @0x2026]];
        [_keyLabels setupKey:0x34 withCharCodesArray:@[@0x88, @0x00A7, @0x0021, @0x0027, @0x007E, @0x00A7, @0x0021, @0x0027, @0x007E]];
        [_keyLabels setupKey:0x35 withCharCodesArray:@[@0x00, @0x003C, @0x003E, @0x2264, @0x2265, @0x003C, @0x003E, @0x2264, @0x2265]];
        [_keyLabels setupKey:0x36 withCharCodesArray:@[@0x00, @0x002C, @0x003F, @0x003C, @0x2264, @0x002C, @0x003F, @0x003C, @0x2264]];
        [_keyLabels setupKey:0x37 withCharCodesArray:@[@0x00, @0x002E, @0x003A, @0x003E, @0x2265, @0x002E, @0x003A, @0x003E, @0x2265]];
        [_keyLabels setupKey:0x38 withCharCodesArray:@[@0x00, @0x002D, @0x005F, @0x2013, @0x2014, @0x002D, @0x005F, @0x2013, @0x2014]];
        [_keyLabels setupKey:0x64 withCharCodesArray:@[@0x00, @0x005C, @0x007C, @0x0000, @0x0000, @0x005C, @0x007C, @0x017B, @0x0000]];
    }
    return _keyLabels;
}
