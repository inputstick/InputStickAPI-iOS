...
@interface InputStickKeyboardLayoutHeILMac () {
...
@implementation InputStickKeyboardLayoutHeILMac
...
- (NSString *)availableCharactersString {
    //\t\n ,-./0123456789:;<=>?[]{|}~ְֱֲֳִֵֶַָֹֻּ֜֞־ֿאבגדהוזחטיךכלםמןנסעףפץצקרשת׳״‎‏–—‘’“”„…₪€
    return @"\t\n ,-./0123456789:;<=>?[]{|}~\u059C\u059E\u05B0\u05B1\u05B2\u05B3\u05B4\u05B5\u05B6\u05B7\u05B8\u05B9\u05BB\u05BC\u05BE\u05BF\u05D0\u05D1\u05D2\u05D3\u05D4\u05D5\u05D6\u05D7\u05D8\u05D9\u05DA\u05DB\u05DC\u05DD\u05DE\u05DF\u05E0\u05E1\u05E2\u05E3\u05E4\u05E5\u05E6\u05E7\u05E8\u05E9\u05EA\u05F3\u05F4\u200E\u200F\u2013\u2014\u2018\u2019\u201C\u201D\u201E\u2026\u20AA\u20AC";
}
...
- (NSArray<NSNumber *> *)availableCharactersLUT {
    if (_availableCharactersLUT == nil) {
        ...
        [lut addObject:[NSNumber numberWithInteger:1436]];
        [lut addObject:[NSNumber numberWithInteger:1438]];
        [lut addObject:[NSNumber numberWithInteger:1456]];
        [lut addObject:[NSNumber numberWithInteger:1457]];
        [lut addObject:[NSNumber numberWithInteger:1458]];
        [lut addObject:[NSNumber numberWithInteger:1459]];
        [lut addObject:[NSNumber numberWithInteger:1460]];
        [lut addObject:[NSNumber numberWithInteger:1461]];
        [lut addObject:[NSNumber numberWithInteger:1462]];
        [lut addObject:[NSNumber numberWithInteger:1463]];
        [lut addObject:[NSNumber numberWithInteger:1464]];
        [lut addObject:[NSNumber numberWithInteger:1465]];
        [lut addObject:[NSNumber numberWithInteger:1467]];
        [lut addObject:[NSNumber numberWithInteger:1468]];
        [lut addObject:[NSNumber numberWithInteger:1470]];
        ...
        [lut addObject:[NSNumber numberWithInteger:1523]];
        [lut addObject:[NSNumber numberWithInteger:1524]];
        [lut addObject:[NSNumber numberWithInteger:8206]];
        [lut addObject:[NSNumber numberWithInteger:8207]];
...
- (InputStickKeyLabels *)keyLabels {
    if (_keyLabels == nil) {
        ...
        [_keyLabels setupKey:0x04 withCharCodesArray:@[@0x00, @0x05E9, @0x0000, @0x0000, @0x0000, @0x0061, @0x0041, @0x00E5, @0x00C5]];
        [_keyLabels setupKey:0x05 withCharCodesArray:@[@0x00, @0x05E0, @0x0000, @0x2018, @0x059C, @0x0062, @0x0042, @0x222B, @0x0131]];
        [_keyLabels setupKey:0x06 withCharCodesArray:@[@0x00, @0x05D1, @0x0000, @0x201C, @0x059E, @0x0063, @0x0043, @0x00E7, @0x00C7]];
        [_keyLabels setupKey:0x07 withCharCodesArray:@[@0x00, @0x05D2, @0x201E, @0x200F, @0x0000, @0x0064, @0x0044, @0x2202, @0x00CE]];
        [_keyLabels setupKey:0x08 withCharCodesArray:@[@0x40, @0x05E7, @0x0000, @0x0000, @0x0000, @0x0065, @0x0045, @0x00B4, @0x00B4]];
        [_keyLabels setupKey:0x09 withCharCodesArray:@[@0x00, @0x05DB, @0x0000, @0x20AC, @0x20AC, @0x0066, @0x0046, @0x0192, @0x00CF]];
        [_keyLabels setupKey:0x0A withCharCodesArray:@[@0x00, @0x05E2, @0x0000, @0x059E, @0x0000, @0x0067, @0x0047, @0x00A9, @0x02DD]];
        [_keyLabels setupKey:0x0B withCharCodesArray:@[@0x00, @0x05D9, @0x0000, @0x0000, @0x0000, @0x0068, @0x0048, @0x02D9, @0x00D3]];
        [_keyLabels setupKey:0x0C withCharCodesArray:@[@0x40, @0x05DF, @0x0000, @0x0000, @0x0000, @0x0069, @0x0049, @0x02C6, @0x02C6]];
        [_keyLabels setupKey:0x0D withCharCodesArray:@[@0x00, @0x05D7, @0x0000, @0x201D, @0x0000, @0x006A, @0x004A, @0x2206, @0x00D4]];
        [_keyLabels setupKey:0x0E withCharCodesArray:@[@0x00, @0x05DC, @0x0000, @0x059C, @0x0000, @0x006B, @0x004B, @0x02DA, @0xF8FF]];
        [_keyLabels setupKey:0x0F withCharCodesArray:@[@0x00, @0x05DA, @0x0000, @0x2019, @0x0000, @0x006C, @0x004C, @0x00AC, @0x00D2]];
        [_keyLabels setupKey:0x10 withCharCodesArray:@[@0x00, @0x05E6, @0x0000, @0x0000, @0x0000, @0x006D, @0x004D, @0x00B5, @0x00C2]];
        [_keyLabels setupKey:0x11 withCharCodesArray:@[@0x40, @0x05DE, @0x0000, @0x2019, @0x2019, @0x006E, @0x004E, @0x02DC, @0x02DC]];
        [_keyLabels setupKey:0x12 withCharCodesArray:@[@0x00, @0x05DD, @0x0000, @0x0000, @0x0000, @0x006F, @0x004F, @0x00F8, @0x00D8]];
        [_keyLabels setupKey:0x13 withCharCodesArray:@[@0x00, @0x05E4, @0x0000, @0x0000, @0x0000, @0x0070, @0x0050, @0x03C0, @0x220F]];
        [_keyLabels setupKey:0x14 withCharCodesArray:@[@0x00, @0x002F, @0x0000, @0x2026, @0x2026, @0x0071, @0x0051, @0x0153, @0x0152]];
        [_keyLabels setupKey:0x15 withCharCodesArray:@[@0x00, @0x05E8, @0x0000, @0x0000, @0x0000, @0x0072, @0x0052, @0x00AE, @0x2030]];
        [_keyLabels setupKey:0x16 withCharCodesArray:@[@0x00, @0x05D3, @0x0000, @0x200E, @0x0000, @0x0073, @0x0053, @0x00DF, @0x00CD]];
        [_keyLabels setupKey:0x17 withCharCodesArray:@[@0x00, @0x05D0, @0x0000, @0x0000, @0x0000, @0x0074, @0x0054, @0x2020, @0x02C7]];
        [_keyLabels setupKey:0x18 withCharCodesArray:@[@0x40, @0x05D5, @0x0000, @0x0000, @0x0000, @0x0075, @0x0055, @0x00A8, @0x00A8]];
        [_keyLabels setupKey:0x19 withCharCodesArray:@[@0x00, @0x05D4, @0x0000, @0x201D, @0x201D, @0x0076, @0x0056, @0x221A, @0x25CA]];
        [_keyLabels setupKey:0x1A withCharCodesArray:@[@0x00, @0x05F3, @0x0000, @0x05B8, @0x05B8, @0x0077, @0x0057, @0x2211, @0x201E]];
        [_keyLabels setupKey:0x1B withCharCodesArray:@[@0x00, @0x05E1, @0x0000, @0x2014, @0x2014, @0x0078, @0x0058, @0x2248, @0x02DB]];
        [_keyLabels setupKey:0x1C withCharCodesArray:@[@0x00, @0x05D8, @0x0000, @0x0000, @0x0000, @0x0079, @0x0059, @0x00A5, @0x00C1]];
        [_keyLabels setupKey:0x1D withCharCodesArray:@[@0x00, @0x05D6, @0x0000, @0x2013, @0x2013, @0x007A, @0x005A, @0x03A9, @0x00B8]];
        [_keyLabels setupKey:0x1E withCharCodesArray:@[@0x00, @0x0031, @0x0000, @0x05B2, @0x05B2, @0x0031, @0x0000, @0x00A1, @0x2044]];
        [_keyLabels setupKey:0x1F withCharCodesArray:@[@0x00, @0x0032, @0x0000, @0x05B3, @0x05B3, @0x0032, @0x0000, @0x2122, @0x20AC]];
        [_keyLabels setupKey:0x20 withCharCodesArray:@[@0x00, @0x0033, @0x0000, @0x05B1, @0x05B1, @0x0033, @0x0000, @0x00A3, @0x2039]];
        [_keyLabels setupKey:0x21 withCharCodesArray:@[@0x00, @0x0034, @0x0000, @0x05B4, @0x05B4, @0x0034, @0x0000, @0x00A2, @0x203A]];
        [_keyLabels setupKey:0x22 withCharCodesArray:@[@0x00, @0x0035, @0x0000, @0x05B5, @0x05B5, @0x0035, @0x0000, @0x221E, @0xFB01]];
        [_keyLabels setupKey:0x23 withCharCodesArray:@[@0x00, @0x0036, @0x0000, @0x05B7, @0x05B7, @0x0036, @0x0000, @0x00A7, @0xFB02]];
        [_keyLabels setupKey:0x24 withCharCodesArray:@[@0x00, @0x0037, @0x20AA, @0x05B8, @0x05B8, @0x0037, @0x0000, @0x00B6, @0x2021]];
        [_keyLabels setupKey:0x25 withCharCodesArray:@[@0x00, @0x0038, @0x0000, @0x05BB, @0x05BB, @0x0038, @0x0000, @0x2022, @0x00B0]];
        [_keyLabels setupKey:0x26 withCharCodesArray:@[@0x00, @0x0039, @0x0000, @0x05B6, @0x05B6, @0x0039, @0x0000, @0x00AA, @0x00B7]];
        [_keyLabels setupKey:0x27 withCharCodesArray:@[@0x00, @0x0030, @0x0000, @0x05B0, @0x05B0, @0x0030, @0x0000, @0x00BA, @0x201A]];
        [_keyLabels setupKey:0x2D withCharCodesArray:@[@0x00, @0x002D, @0x0000, @0x0000, @0x0000, @0x0000, @0x0000, @0x2013, @0x2014]];
        [_keyLabels setupKey:0x2E withCharCodesArray:@[@0x00, @0x003D, @0x0000, @0x05B9, @0x05B9, @0x0000, @0x0000, @0x2260, @0x00B1]];
        [_keyLabels setupKey:0x2F withCharCodesArray:@[@0x00, @0x005D, @0x007D, @0x0000, @0x0000, @0x0000, @0x0000, @0x201C, @0x201D]];
        [_keyLabels setupKey:0x30 withCharCodesArray:@[@0x00, @0x005B, @0x007B, @0x0000, @0x0000, @0x0000, @0x0000, @0x2018, @0x2019]];
        [_keyLabels setupKey:0x31 withCharCodesArray:@[@0x00, @0x05BF, @0x007C, @0x05BE, @0x05BE, @0x005C, @0x007C, @0x00AB, @0x00BB]];
        [_keyLabels setupKey:0x33 withCharCodesArray:@[@0x00, @0x05E3, @0x003A, @0x003B, @0x003B, @0x0000, @0x0000, @0x2026, @0x00DA]];
        [_keyLabels setupKey:0x34 withCharCodesArray:@[@0x00, @0x002C, @0x05F4, @0x05B2, @0x05B2, @0x0000, @0x0000, @0x00E6, @0x00C6]];
        [_keyLabels setupKey:0x35 withCharCodesArray:@[@0x40, @0x003B, @0x007E, @0x0000, @0x0000, @0x0060, @0x007E, @0x0060, @0x0060]];
        [_keyLabels setupKey:0x36 withCharCodesArray:@[@0x00, @0x05EA, @0x003E, @0x05BC, @0x05BC, @0x0000, @0x0000, @0x2264, @0x00AF]];
        [_keyLabels setupKey:0x37 withCharCodesArray:@[@0x00, @0x05E5, @0x003C, @0x0000, @0x0000, @0x0000, @0x0000, @0x2265, @0x02D8]];
        [_keyLabels setupKey:0x38 withCharCodesArray:@[@0x00, @0x002E, @0x003F, @0x0000, @0x0000, @0x0000, @0x0000, @0x00F7, @0x00BF]];
    }
    return _keyLabels;
}
