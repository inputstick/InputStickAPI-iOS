...
@interface InputStickKeyboardLayoutPlPL () {
...
@implementation InputStickKeyboardLayoutPlPL
...
- (InputStickKeyLabels *)keyLabels {
    if (_keyLabels == nil) {
        ...
        [_keyLabels setupKey:0x35 withCharCodesArray:@[@0x22, @0x0060, @0x007E, @0x0000, @0x0000, @0x0060, @0x007E, @0x0000, @0x0000]];
