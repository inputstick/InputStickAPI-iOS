...
@interface InputStickKeyboardLayoutPlPLMac () {
...
@implementation InputStickKeyboardLayoutPlPLMac
...
- (InputStickKeyboardKeyModel *)keyModelForCharacter:(int)character {
    ...
    switch (character) {
            ...
            case 363: // ū
                ...
                break;
            case 366: // Ů
                keyboardKeyModel = [[InputStickKeyboardKeyModel alloc]initWithUnicodeCharacter:character key:18 modifiers:2 deadkey:53 deadkeyModifiers:64];
                break;
            case 367: // ů
...
- (NSString *)availableCharactersString {
    //\t\n !"#$%&'()*+,-./0123456789:;<=>?@ABCDEFGHIJKLMNOPQRSTUVWXYZ[\]^_`abcdefghijklmnopqrstuvwxyz{|}~£§¨©«®°¶»ÁÄÓÔÖÚÜÝßäóôö÷üýĄąĆćČĎďĒēėĘęĚěģĪīįĶķĺĻļĽľŁłŃńņňŌōőŔŕŖŗŘřŚśŠŤťŪūŮůŰűųŹźŻżŽž–—’‚”„†•…‹›€™∂∆∑√≠≤≥◊
    return @"\t\n !\"#$%&\'()*+,-./0123456789:;<=>?@ABCDEFGHIJKLMNOPQRSTUVWXYZ[\\]^_`abcdefghijklmnopqrstuvwxyz{|}~\u00A3\u00A7\u00A8\u00A9\u00AB\u00AE\u00B0\u00B6\u00BB\u00C1\u00C4\u00D3\u00D4\u00D6\u00DA\u00DC\u00DD\u00DF\u00E4\u00F3\u00F4\u00F6\u00F7\u00FC\u00FD\u0104\u0105\u0106\u0107\u010C\u010E\u010F\u0112\u0113\u0117\u0118\u0119\u011A\u011B\u0123\u012A\u012B\u012F\u0136\u0137\u013A\u013B\u013C\u013D\u013E\u0141\u0142\u0143\u0144\u0146\u0148\u014C\u014D\u0151\u0154\u0155\u0156\u0157\u0158\u0159\u015A\u015B\u0160\u0164\u0165\u016A\u016B\u016E\u016F\u0170\u0171\u0173\u0179\u017A\u017B\u017C\u017D\u017E\u2013\u2014\u2019\u201A\u201D\u201E\u2020\u2022\u2026\u2039\u203A\u20AC\u2122\u2202\u2206\u2211\u221A\u2260\u2264\u2265\u25CA";
}
...
- (InputStickKeyLabels *)keyLabels {
    if (_keyLabels == nil) {
        ...
        [_keyLabels setupKey:0x05 withCharCodesArray:@[@0x00, @0x0062, @0x0042, @0x013C, @0x0171, @0x0042, @0x0042, @0x0171, @0x0171]];
        [_keyLabels setupKey:0x06 withCharCodesArray:@[@0x00, @0x0063, @0x0043, @0x0107, @0x0106, @0x0043, @0x0043, @0x0106, @0x0106]];
        [_keyLabels setupKey:0x07 withCharCodesArray:@[@0x00, @0x0064, @0x0044, @0x2202, @0x017D, @0x0044, @0x0044, @0x017D, @0x017D]];
        [_keyLabels setupKey:0x08 withCharCodesArray:@[@0x00, @0x0065, @0x0045, @0x0119, @0x0118, @0x0045, @0x0045, @0x0118, @0x0118]];
        [_keyLabels setupKey:0x09 withCharCodesArray:@[@0x00, @0x0066, @0x0046, @0x0144, @0x017E, @0x0046, @0x0046, @0x017E, @0x017E]];
        [_keyLabels setupKey:0x0A withCharCodesArray:@[@0x00, @0x0067, @0x0047, @0x00A9, @0x016A, @0x0047, @0x0047, @0x016A, @0x016A]];
        [_keyLabels setupKey:0x0B withCharCodesArray:@[@0x00, @0x0068, @0x0048, @0x0137, @0x00D3, @0x0048, @0x0048, @0x00D3, @0x00D3]];
        ...
        [_keyLabels setupKey:0x0E withCharCodesArray:@[@0x00, @0x006B, @0x004B, @0x017B, @0x016B, @0x004B, @0x004B, @0x016B, @0x016B]];
        ...
        [_keyLabels setupKey:0x11 withCharCodesArray:@[@0x00, @0x006E, @0x004E, @0x0144, @0x0143, @0x004E, @0x004E, @0x0143, @0x0143]];
        [_keyLabels setupKey:0x12 withCharCodesArray:@[@0x00, @0x006F, @0x004F, @0x00F3, @0x00D3, @0x004F, @0x004F, @0x00D3, @0x00D3]];
        [_keyLabels setupKey:0x13 withCharCodesArray:@[@0x00, @0x0070, @0x0050, @0x013B, @0x0142, @0x0050, @0x0050, @0x0142, @0x0142]];
        [_keyLabels setupKey:0x14 withCharCodesArray:@[@0x00, @0x0071, @0x0051, @0x014C, @0x0151, @0x0051, @0x0051, @0x0151, @0x0151]];
        [_keyLabels setupKey:0x15 withCharCodesArray:@[@0x00, @0x0072, @0x0052, @0x00AE, @0x00A3, @0x0052, @0x0052, @0x015A, @0x00A3]];
        [_keyLabels setupKey:0x16 withCharCodesArray:@[@0x00, @0x0073, @0x0053, @0x015B, @0x015A, @0x0053, @0x0053, @0x015A, @0x015A]];
        [_keyLabels setupKey:0x17 withCharCodesArray:@[@0x00, @0x0074, @0x0054, @0x2020, @0x015B, @0x0054, @0x0054, @0x015B, @0x015B]];
        [_keyLabels setupKey:0x18 withCharCodesArray:@[@0x04, @0x0075, @0x0055, @0x00A8, @0x0164, @0x0055, @0x0055, @0x0164, @0x0164]];
        ...
        [_keyLabels setupKey:0x1B withCharCodesArray:@[@0x00, @0x0078, @0x0058, @0x017A, @0x0179, @0x0058, @0x0058, @0x0179, @0x0179]];
        [_keyLabels setupKey:0x1C withCharCodesArray:@[@0x00, @0x0079, @0x0059, @0x012B, @0x00C1, @0x0059, @0x0059, @0x00C1, @0x00C1]];
        [_keyLabels setupKey:0x1D withCharCodesArray:@[@0x00, @0x007A, @0x005A, @0x017C, @0x017B, @0x005A, @0x005A, @0x017B, @0x017B]];
        [_keyLabels setupKey:0x1E withCharCodesArray:@[@0x00, @0x0031, @0x0021, @0x0143, @0x0155, @0x0031, @0x0021, @0x0143, @0x0155]];
        [_keyLabels setupKey:0x1F withCharCodesArray:@[@0x00, @0x0032, @0x0040, @0x2122, @0x0158, @0x0032, @0x0040, @0x2122, @0x0158]];
        [_keyLabels setupKey:0x20 withCharCodesArray:@[@0x00, @0x0033, @0x0023, @0x20AC, @0x2039, @0x0033, @0x0023, @0x00A3, @0x2039]];
        [_keyLabels setupKey:0x21 withCharCodesArray:@[@0x00, @0x0034, @0x0024, @0x00DF, @0x203A, @0x0034, @0x0024, @0x0118, @0x203A]];
        [_keyLabels setupKey:0x22 withCharCodesArray:@[@0x00, @0x0035, @0x0025, @0x012F, @0x0159, @0x0035, @0x0025, @0x012F, @0x0159]];
        [_keyLabels setupKey:0x23 withCharCodesArray:@[@0x00, @0x0036, @0x005E, @0x00A7, @0x0156, @0x0036, @0x005E, @0x00A7, @0x0156]];
        [_keyLabels setupKey:0x24 withCharCodesArray:@[@0x00, @0x0037, @0x0026, @0x00B6, @0x0157, @0x0037, @0x0026, @0x00B6, @0x0157]];
        [_keyLabels setupKey:0x25 withCharCodesArray:@[@0x00, @0x0038, @0x002A, @0x2022, @0x00B0, @0x0038, @0x002A, @0x2022, @0x00B0]];
        [_keyLabels setupKey:0x26 withCharCodesArray:@[@0x00, @0x0039, @0x0028, @0x013D, @0x0160, @0x0039, @0x0028, @0x013D, @0x0160]];
        [_keyLabels setupKey:0x27 withCharCodesArray:@[@0x00, @0x0030, @0x0029, @0x013E, @0x201A, @0x0030, @0x0029, @0x013E, @0x201A]];
        [_keyLabels setupKey:0x2D withCharCodesArray:@[@0x00, @0x002D, @0x005F, @0x2013, @0x2014, @0x002D, @0x005F, @0x2013, @0x2014]];
        [_keyLabels setupKey:0x2E withCharCodesArray:@[@0x00, @0x003D, @0x002B, @0x2260, @0x012A, @0x003D, @0x002B, @0x2260, @0x012A]];
        [_keyLabels setupKey:0x2F withCharCodesArray:@[@0x00, @0x005B, @0x007B, @0x201E, @0x201D, @0x005B, @0x007B, @0x201C, @0x201D]];
        [_keyLabels setupKey:0x30 withCharCodesArray:@[@0x00, @0x005D, @0x007D, @0x201A, @0x2019, @0x005D, @0x007D, @0x2018, @0x2019]];
        ...
        [_keyLabels setupKey:0x34 withCharCodesArray:@[@0x00, @0x0027, @0x0022, @0x013A, @0x0123, @0x0027, @0x0022, @0x0123, @0x0123]];
        [_keyLabels setupKey:0x35 withCharCodesArray:@[@0x04, @0x0060, @0x007E, @0x0060, @0x0154, @0x0060, @0x007E, @0x0060, @0x0154]];
        [_keyLabels setupKey:0x36 withCharCodesArray:@[@0x00, @0x002C, @0x003C, @0x2264, @0x00DD, @0x002C, @0x003C, @0x2264, @0x00DD]];
        [_keyLabels setupKey:0x37 withCharCodesArray:@[@0x00, @0x002E, @0x003E, @0x2265, @0x00FD, @0x002E, @0x003E, @0x2265, @0x00FD]];
        [_keyLabels setupKey:0x38 withCharCodesArray:@[@0x00, @0x002F, @0x003F, @0x00F7, @0x0146, @0x002F, @0x003F, @0x00F7, @0x0146]];
    }
    return _keyLabels;
}
