...
@interface InputStickKeyboardLayoutPtBRMac () {
...
@implementation InputStickKeyboardLayoutPtBRMac
...
- (NSString *)layoutFullName {
    return @"Portuguese (Português) [BR macOS]";
}
...
- (NSString *)availableCharactersString {
    //\t\n !"#$%&'()*+,-./0123456789:;<=>?@ABCDEFGHIJKLMNOPQRSTUVWXYZ[\]^_`abcdefghijklmnopqrstuvwxyz{|}~¡¢£¥§¨©ª«¬®¯°±´µ¶·¸º»¿ÁÂÃÄÅÆÇÉÊËÍÎÏÑÒÓÔÕÖØÚÛÜßáâãäåæçéêëíîïñóôõö÷øúûüÿıŒœŸƒˆˇ˘˙˚˛˜˝Ωπ–—‘’‚“”„†‡•…‰‹›⁄€™∂∆∏∑√∞∫≈≠≤≥◊ﬁﬂ
    return @"\t\n !\"#$%&\'()*+,-./0123456789:;<=>?@ABCDEFGHIJKLMNOPQRSTUVWXYZ[\\]^_`abcdefghijklmnopqrstuvwxyz{|}~\u00A1\u00A2\u00A3\u00A5\u00A7\u00A8\u00A9\u00AA\u00AB\u00AC\u00AE\u00AF\u00B0\u00B1\u00B4\u00B5\u00B6\u00B7\u00B8\u00BA\u00BB\u00BF\u00C1\u00C2\u00C3\u00C4\u00C5\u00C6\u00C7\u00C9\u00CA\u00CB\u00CD\u00CE\u00CF\u00D1\u00D2\u00D3\u00D4\u00D5\u00D6\u00D8\u00DA\u00DB\u00DC\u00DF\u00E1\u00E2\u00E3\u00E4\u00E5\u00E6\u00E7\u00E9\u00EA\u00EB\u00ED\u00EE\u00EF\u00F1\u00F3\u00F4\u00F5\u00F6\u00F7\u00F8\u00FA\u00FB\u00FC\u00FF\u0131\u0152\u0153\u0178\u0192\u02C6\u02C7\u02D8\u02D9\u02DA\u02DB\u02DC\u02DD\u03A9\u03C0\u2013\u2014\u2018\u2019\u201A\u201C\u201D\u201E\u2020\u2021\u2022\u2026\u2030\u2039\u203A\u2044\u20AC\u2122\u2202\u2206\u220F\u2211\u221A\u221E\u222B\u2248\u2260\u2264\u2265\u25CA\uF8FF\uFB01\uFB02";
}
...
- (InputStickKeyLabels *)keyLabels {
    if (_keyLabels == nil) {
        ...
        [_keyLabels setupKey:0x35 withCharCodesArray:@[@0x00, @0x00A7, @0x00B1, @0x00A7, @0x00B1, @0x00A7, @0x00B1, @0x00A7, @0x00B1]];
        ...
        [_keyLabels setupKey:0x64 withCharCodesArray:@[@0x04, @0x0060, @0x007E, @0x0060, @0x0060, @0x0060, @0x007E, @0x0060, @0x0060]];
    }
    return _keyLabels;
}
