...
@interface InputStickKeyboardLayoutJpJP () {
...
@implementation InputStickKeyboardLayoutJpJP
...
- (InputStickKeyboardKeyModel *)keyModelForCharacter:(int)character {
    ...
    switch (character) {
            ...
            case 91: // [
                ...
                break;
            case 92: // backslash
                keyboardKeyModel = [[InputStickKeyboardKeyModel alloc]initWithUnicodeCharacter:character key:135 modifiers:0 deadkey:0 deadkeyModifiers:0];
                break;
            case 93: // ]
            ...
            case 94: // ^
                ...
                break;
            case 95: // _
                keyboardKeyModel = [[InputStickKeyboardKeyModel alloc]initWithUnicodeCharacter:character key:135 modifiers:2 deadkey:0 deadkeyModifiers:0];
                break;
            case 96: // `
            ...
            case 123: // {
                ...
                break;
            case 124: // |
                keyboardKeyModel = [[InputStickKeyboardKeyModel alloc]initWithUnicodeCharacter:character key:137 modifiers:2 deadkey:0 deadkeyModifiers:0];
                break;
            case 125: // }
            ...
            case 126: // ~
                ...
                break;
            case 165: // ¥
                keyboardKeyModel = [[InputStickKeyboardKeyModel alloc]initWithUnicodeCharacter:character key:137 modifiers:0 deadkey:0 deadkeyModifiers:0];
                break;
    }
...
- (InputStickKeyLabels *)keyLabels {
    if (_keyLabels == nil) {
        ...
        [_keyLabels setupKey:0x08 withCharCodesArray:@[@0x00, @0x0065, @0x0045, @0x0000, @0x0000, @0x0045, @0x0065, @0x0000, @0x0000]];
        ...
        [_keyLabels setupKey:0x24 withCharCodesArray:@[@0x00, @0x0037, @0x0027, @0x0000, @0x0000, @0x0037, @0x0027, @0x0000, @0x0000]];
        ...
        [_keyLabels setupKey:0x27 withCharCodesArray:@[@0x00, @0x0030, @0x0000, @0x0000, @0x0000, @0x0030, @0x0000, @0x0000, @0x0000]];
        [_keyLabels setupKey:0x2D withCharCodesArray:@[@0x00, @0x002D, @0x003D, @0x0000, @0x0000, @0x002D, @0x003D, @0x0000, @0x0000]];
        [_keyLabels setupKey:0x2E withCharCodesArray:@[@0x00, @0x005E, @0x007E, @0x0000, @0x0000, @0x005E, @0x007E, @0x0000, @0x0000]];
        [_keyLabels setupKey:0x2F withCharCodesArray:@[@0x00, @0x0040, @0x0060, @0x0000, @0x0000, @0x0040, @0x0060, @0x0000, @0x0000]];
        [_keyLabels setupKey:0x30 withCharCodesArray:@[@0x00, @0x005B, @0x007B, @0x0000, @0x0000, @0x005B, @0x007B, @0x0000, @0x0000]];
        [_keyLabels setupKey:0x31 withCharCodesArray:@[@0x00, @0x005D, @0x007D, @0x0000, @0x0000, @0x005D, @0x007D, @0x0000, @0x0000]];
        [_keyLabels setupKey:0x33 withCharCodesArray:@[@0x00, @0x003B, @0x002B, @0x0000, @0x0000, @0x003B, @0x002B, @0x0000, @0x0000]];
        [_keyLabels setupKey:0x34 withCharCodesArray:@[@0x00, @0x003A, @0x002A, @0x0000, @0x0000, @0x003A, @0x002A, @0x0000, @0x0000]];
        [_keyLabels setupKey:0x35 withCharCodesArray:@[@0x00, @0x0000, @0x0000, @0x0000, @0x0000, @0x0000, @0x0000, @0x0000, @0x0000]];
        ...
        [_keyLabels setupKey:0x87 withCharCodesArray:@[@0x00, @0x005C, @0x005F, @0x0000, @0x0000, @0x005C, @0x005F, @0x0000, @0x0000]];
        [_keyLabels setupKey:0x89 withCharCodesArray:@[@0x00, @0x00A5, @0x007C, @0x0000, @0x0000, @0x00A5, @0x007C, @0x0000, @0x0000]];
    }
    return _keyLabels;
}
