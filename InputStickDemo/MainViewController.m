...
- (void)loadView {
    ...
    self.connectButton = [[UIButton alloc] initWithFrame:CGRectMake(15, 15, 290, 44)];
    ...
    self.reconnectButton = [[UIButton alloc] initWithFrame:CGRectMake(15, CGRectGetMaxY(self.connectButton.frame) + 15, 290, 44)];
    ...
    self.disconnectButton = [[UIButton alloc] initWithFrame:CGRectMake(15, CGRectGetMaxY(self.reconnectButton.frame) + 15, 290, 44)];
    ...
    self.sendDataButton = [[UIButton alloc] initWithFrame:CGRectMake(15, CGRectGetMaxY(self.disconnectButton.frame) + 15, 290, 44)];
